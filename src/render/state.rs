...
use crate::{camera, io, model, render, texture};
use cgmath::prelude::*;
use std::iter;
...
pub struct State {
    pub(super) init: render::WgpuInit,
...
impl State {
    pub async fn new(window: &Window) -> Self {
        let init = render::WgpuInit::init_wgpu(window).await;
        ...
        let depth_texture =
            texture::Texture::create_depth_texture(&init.device, &init.config, "depth_texture");
